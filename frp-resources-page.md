...
ACM Principles and Practice of Declarative Programming 2019.*

[Fault Tolerant Functional Reactive Programming (Functional Pearl)](https://dl.acm.org/doi/pdf/10.1145/3236791)\
*Ivan Perez.\
...
*Ivan Perez, Henrik Nilsson.\
ACM SIGPLAN Haskell Symposium 2015.*
...
[Settable and Non-Interfering Signal Functions for FRP - How a First-Order Switch is More Than Enough](https://www.danwc.com/data/nichoiceICFP2014.pdf)\
*Daniel Winograd-Cort, Paul Hudak.\
ACM International Conference on Functional Programming 2014.*


[Practical Functional Reactive Programming](https://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.641.2167)\
*John Peterson, Ken Roe, Alan Cleary.\
Practical Aspects of Declarative Languages 2014.*


[Monadic Functional Reactive Programming](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.725.310&rep=rep1&type=pdf)\
*Atze van der Ploeg.\
...
[Virtualizing Real-World Objects in FRP](https://www.thev.net/PaulLiu/download/virtualizing.pdf)\
...
[ACM Page](https://dl.acm.org/doi/abs/10.1145/871895.871897).


[Arrows, Robots, and Functional Reactive Programming](https://www.cs.yale.edu/homes/hudak/CS429F04/AFPLectureNotes.pdf)\
*Paul Hudak, Antony Courtney, Henrik Nilsson, John Peterson.\
Springer Lecture Notes in Computer Science 2002.*
...
ACM SIGPLAN Workshop on Haskell 2002.*

[Frappé: Functional Reactive Programming in Java](https://www.antonycourtney.com/pubs/frappe-padl01.pdf)\
*Antony Courtney.\
ACM SIGPLAN Practical Aspects of Declarative Languages 2001.*

[Genuinely Functional User Interfaces](http://conal.net/papers/genuinely-functional-guis.pdf)
*Antony Courtney, Conal Elliot.\
ACM SIGPLAN Workshop on Haskell 2001.*

[Event-Driven FRP](https://www.researchgate.net/publication/2415013_Event-driven_FRP)\
*Zhanyong Wan, Walid Taha, Paul Hudak.\
Springer Lecture Notes in Computer Science 2001.*

[Real-Time FRP](https://web.archive.org/web/20160803214617/http://haskell.cs.yale.edu/wp-content/uploads/2011/02/rt-frp.pdf)\
...
[FranTk - A Declarative GUI Language for Haskell](https://dl.acm.org/doi/pdf/10.1145/357766.351250)\
*Meurig Sage.\
ACM SIGPLAN International Conference on Functional Programming 2000.*
...
*Conal Elliot.\
ACM International Principles and Practice of Declarative Programming (PPDP) 2000.*

[Functional Reactive Programming from First Principles](https://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.23.360)\
*Zhanyong Wan, Paul Hudak.\
ACM SIGPLAN Programming Language Design and Implementation (PLDI) 2000.*

[Principles of Functional Reactive Programming](https://dl.acm.org/doi/pdf/10.1145/340855.340961) (short excerpt)\
*Paul Hudak.\
ACM SIGSOFT Software Engineering Notes (SEN) 2000.*

[Prototyping Real-Time Vision Systems: An Experiment in DSL Design](https://dl.acm.org/doi/pdf/10.1145/302405.302681)\
*Alastair Reid, John Peterson, Greg Hager, Paul Hudak.\
ACM International Conference on Software Engineering (ICSE) 1999.*

[Lambda In Motion - Controlling Robots with Haskell](https://www.researchgate.net/publication/2245424_Lambda_in_Motion_Controlling_Robots_With_Haskell)\
*John Peterson, Paul Hudak, Conal Elliot.\
Springer Lecture Notes in Computer Science (LNCS) Practical Aspects of Declarative Languages (PADL) 1999.*

[From Functional Animation to Sprite-Based Display](http://conal.net/papers/padl99/)\
*Conal Elliot.\
Springer Lecture Notes in Computer Science (LNCS) Practical Aspects of Declarative Languages (PADL) 1999.*

[Functional Implementations of Continuous Modeled Animation (Expanded Version)](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/tr-98-25.pdf)\
*Conal Elliot.\
...
ACM SIGPLAN International Conference of Functional Programming 1997.*
...
[Functional 3D Graphics in C++ with an Object-Oriented, Multiple Dispatching Implementation](http://conal.net/papers/eoog94.pdf)\
*Greg Schechter, Conal Elliot, Ricky Yeung, Salim Abi-Ezzi.\
SunSoft Inc 1994.*

[MediaFlow - A Framework for Distributed Integrated Media](http://conal.net/papers/MediaFlow.pdf)\
*Conal Elliot, Greg Schecter, Salim Abi-Ezzi.\
SunSoft Inc 1994.*
